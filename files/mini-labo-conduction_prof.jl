...
md"""
Le système de conduction cardiaque est un complexe réseau de cellules cardiaques spécialisées qui orchestrent et coordonnent la contraction systolique et la relaxation diastolique du cœur. Ce système est crucial pour le fonctionnement efficace du cœur en tant que pompe, car il génère et transmet des impulsions électriques qui déclenchent la contraction des cardiomyocytes. La coordination précise de ces contractions cellulaires est essentielle pour assurer un flux sanguin adéquat à travers tout l'organisme. 
...
md"""
L'image du coeur ci-bas montre les structures centrales du système de conduction cardiaque (en orange). La vitesse de conduction approximative associée à chaque structure est indiquée entre parenthèse en rouge. Le moment (en seconde) auquel l'activation a lieu est indiqué en vert. Il faut noter que, dans des conditions physiologiques comme dans l'exemple ci-bas, le temps **t = 0.0 sec** corresponds au moment où le noeud SA s'active.
"""
